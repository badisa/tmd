...
def build_openmm_topology(objs: list[app.Topology | Chem.Mol]) -> app.Topology:
    """Convert a list of Chem.Mol or app.Topology objects into a single OpenMM topology.

    Useful for use with other libraries such as MDTraj, MDAnalysis, etc
...
class CIFWriter:
    def __init__(self, objs, out_filepath):
        ...
        combined_topology = build_openmm_topology(objs)
